module controller(
    ...
    // ALU操作数来源
    assign src1_is_pc     = inst_pcaddu12i;
    assign src1_is_zero   = inst_lu12i_w;
    ...
    assign rf_dst_is_r1   = inst_bl;
    assign rf_src_is_mem  = type_load;
    assign rf_src_is_link = inst_bl | inst_jirl;

    // 存储器控制
    assign mem_en      = type_load | type_store;
    assign raddr2_is_rd = inst_beq | inst_bne | type_store;
